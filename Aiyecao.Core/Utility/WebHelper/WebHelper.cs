...
namespace Aiyecao.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Aiyecao.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Aiyecao.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Aiyecao.IsPOSTBeingDone"] = value;
            }
        }
